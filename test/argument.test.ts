...
describe("Argument", () => {
    describe("Constructor", () => {
        ...
        test("Out of range", () => {
            expect(() => new Argument(new DummyItem(), -1)).toThrow();
            expect(() => new Argument(new DummyItem(), 27)).toThrow();
        })
        test("Not items", () => {
            expect(() => new Argument({} as any, 0)).toThrow();
        })
    })
})
...
describe("Item",() => {
    describe("Abstract", () => {
        ...
        test("Bad data", () => {
            //@ts-ignore // why
            expect(() => new TestItem()).toThrow();
            // expect(() => new TestItem('test',null)).toThrow()
            expect(() => new TestItem('{"key":"value"')).toThrow();
        });
    });
    ...
    describe("Named", () => {
        ...
        test("Bad value", () => {
            expect(() => new Text('hello' as any)).toThrow();
        });
        ...
        describe("Variable", () => {
            ...
            test("Invalid", () => {
                expect(() => new Variable({name:'var'} as any)).toThrow();
                expect(() => new Variable({scope:'local'} as any)).toThrow();
                expect(() => new Variable({name:'var',scope:'invalid'} as any)).toThrow();
            });
        });
    });
    ...
    describe("Vector", () => {
        ...
        test("Invalid",() => {
            expect(() => new Vector({y:1,z:1} as any)).toThrow()
            expect(() => new Vector({x:1,z:1} as any)).toThrow()
            expect(() => new Vector({x:1,y:1} as any)).toThrow()
        })
    })
    ...
    describe("Potion", () => {
        ...
        test("Invalid", () => {
            //@ts-ignore
            expect(() => new Potion({dur: 100000, amp: 4})).toThrow()
            //@ts-ignore
            expect(() => new Potion({pot: "potion", amp: 4})).toThrow()
            //@ts-ignore
            expect(() => new Potion({pot: "potion", dur: 100000})).toThrow()
        })
    })
    ...
    describe("Sound", () => {
        ...
        test("Invalid", () => {
            //@ts-ignore
            expect(() => new Sound({pitch:1,vol:2})).toThrow()
            //@ts-ignore
            expect(() => new Sound({sound:"sound",vol:2})).toThrow()
            //@ts-ignore
            expect(() => new Sound({sound:"sound",pitch:1})).toThrow()
        })
    })
    ...
    describe("Block Tag", () => {
        ...
        test("Invalid", () => {
            //@ts-ignore
            expect(() => new BlockTag({tag: "tag", action: "action", block: "block"})).toThrow()
            //@ts-ignore
            expect(() => new BlockTag({option: "option", action: "action", block: "block"})).toThrow()
            //@ts-ignore
            expect(() => new BlockTag({option: "option", tag: "tag", block: "block"})).toThrow()
            //@ts-ignore
            expect(() => new BlockTag({option: "option", tag: "tag", action: "action"})).toThrow()
    ...
    describe("Minecraft Item", () => {
        ...
        test("Invalid", () => {
            //@ts-ignore
            expect(() => new MinecraftItem({})).toThrow()
            //@ts-ignore
            expect(() => new MinecraftItem({item:{Count:1}})).toThrow()
        })
    })
})
