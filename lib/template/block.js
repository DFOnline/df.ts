...
var ActionBlock = /** @class */ (function (_super) {
    ...
    function ActionBlock(block, action, inverted, args) {
        if (inverted === void 0) { inverted = ''; }
        var _this = _super.call(this, block, args) || this;
        _this.inverted = '';
        _this.action = action;
...
var SelectionBlock = /** @class */ (function (_super) {
    ...
    function SelectionBlock(block, action, target, inverted, args) {
        var _this = _super.call(this, block, action, inverted, args) || this;
        _this.target = "";
...
var SubActionBlock = /** @class */ (function (_super) {
    ...
    function SubActionBlock(block, action, subAction, inverted, args) {
        var _this = _super.call(this, block, action, inverted, args) || this;
